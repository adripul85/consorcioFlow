...
const BankBalanceManager: React.FC<BankBalanceManagerProps> = ({ 
  ...
  const totalBalance = useMemo(() => (Object.values(accountBalances) as number[]).reduce((sum: number, b: number) => sum + b, 0), [accountBalances]);
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      {activeTab === 'cheques' && (
        <div className="space-y-8 animate-in slide-in-from-right-4">
           {/* ... Contenido de cheques se mantiene igual ... */}
